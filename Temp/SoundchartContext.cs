...
public partial class SoundchartContext : DbContext
{
    public SoundchartContext()
    {
    }

    public SoundchartContext(DbContextOptions<SoundchartContext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=soundchart.mssql.somee.com;Initial Catalog=soundchart;User Id=pascalmk_SQLLogin_1;Password=ze4wki75nm;Encrypt=False;TrustServerCertificate=True");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.CountryId).HasName("PK__Country__10D1609F08012F48");
